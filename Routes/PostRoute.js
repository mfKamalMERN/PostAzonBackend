...
import { AddComment, CreatePost, DeleteComment, DeletePost, GetAllPosts, GetMyPosts, LikeUnlike, UpdateComment, UploadSingle } from '../Controllers/PostController.js'
...
postRoute.get(`/myposts/:userid`, verifyToken, GetMyPosts)
